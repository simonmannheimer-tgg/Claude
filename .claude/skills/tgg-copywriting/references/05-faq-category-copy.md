...
Generate FAQ sections and longer category copy for The Good Guys product pages. Three sub-tasks.
...
**1 — Intent Analysis:** Determine primary intent from URL, generate 5+ related sub-queries.

**2 — Existing Intro Check:** Review existing intro, avoid repeating exact phrases or covering the same features the same way. Provide complementary information with a different angle.
...
```
Only use links with HTTP status = 200.

**4 — Entity Identification:** Extract minimum 5 entities (technologies, models/formats, capacities, specifications, smart features).

**5 — Write 4 Paragraphs:**
...
- [ ] Exactly 1 list
- [ ] 0 parent links
- [ ] All links status = 200 (if verifiable)
- [ ] Natural brand tone
- [ ] No cannibalisation of existing intro
- [ ] No hard-banned words (see `00-tov.md`)

---

## Task 5C: Extended PLP Intro Copy (230–260 Words)

> **Important:** This is 230–260 WORDS, not characters. Process 01 is characters. Do not confuse.
